...
import com.techtastic.dictionary.Models.Phonetics;
import com.techtastic.dictionary.R;
import com.techtastic.dictionary.ViewHolders.PhoneticViewHolder;
    ...
    public void onBindViewHolder(@NonNull PhoneticViewHolder holder, int position) {
        ...
        holder.imageButton_audio.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try{
                    player.setAuxEffectSendLevel(AudioManager.STREAM_MUSIC);
